...
해쉬 테이블이란, 키와 값을 쌍으로 저장하는 자료 구조입니다. 예를 들어서, 회사가 있다고 가정해봅시다. 

![ht1](../images/ch22/ht1.png)

이 회사는 사원들을 관리하기 위해서 사원 번호와, 사원 정보를 쌍으로 저장하고 사원 검색 사이트가 있습니다.

![ht2](../images/ch22/ht2.png)

만약, 사번 "00001"을 가진  "구르미"라는 사원의 정보를 검색한다고 합시다.

![ht3](../images/ch22/ht3.png)

어떻게 검색할 수 있을까요? 그냥 사번을 검색란에 치면 됩니다.

![ht4](../images/ch22/ht4.png)
...
![ht7](../images/ch22/ht7.png)

위의 해쉬 함수는 사번 끝자릿수 2자리를 가지고 키에 대한 해쉬 값을 찾습니다. 즉, "00001"이면, "01"로 바로 접근이 되는 것이죠.
...
다음 그림은 한 해슁 값에 대해서 여러 슬롯을 가진 테이블에 대해서 데이터 검색을 표현하고 있습니다.
...
다음 그림은 데이터 삽입 시, 다른 키인데, 해슁 함수에 대해서 충돌이 난 경우를 표현하고 있습니다.
...
다음 그림은 한 해슁 값에 대해서 여러 슬롯을 가진 테이블에 대해서 데이터 삭제를 표현하고 있습니다.
